...
local function SetUIScale(scale)
    pcall(function()
        -- WindUI window scale (best-effort)
...
local Tabs = {
    Info = Window:Tab({ Title = "Info And Status", Icon = "info" }),
    Main = Window:Tab({ Title = "Farming", Icon = "swords" }),
    Settings = Window:Tab({ Title = "Setting", Icon = "settings" }),
    Fish = Window:Tab({ Title = "Fishing", Icon = "fish" }),
    Quests = Window:Tab({ Title = "Quest And Item", Icon = "scroll-text" }),
    SeaEvent = Window:Tab({ Title = "Sea Event", Icon = "waves" }),
    Race = Window:Tab({ Title = "Mirage And Race", Icon = "moon" }),
    Prehistoric = Window:Tab({ Title = "Volcano Event", Icon = "flame" }),
    Esp = Window:Tab({ Title = "Stats And Esp", Icon = "eye" }),
    Raids = Window:Tab({ Title = "Fruit And Raid", Icon = "zap" }),
    Combat = Window:Tab({ Title = "Local Player", Icon = "user" }),
    Travel = Window:Tab({ Title = "Teleport", Icon = "map-pin" }),
    Shop = Window:Tab({ Title = "Shopping", Icon = "shopping-cart" }),
    Misc = Window:Tab({ Title = "Miscellaneous", Icon = "more-horizontal" })
}

Tabs.Info:Section({ Title = "Information" })


Tabs.Info:Section({ Title = "Status Server" })

local TimeZone = Tabs.Info:Paragraph({ Title = "Time Zone", Desc = "" })
...
local GameTime = Tabs.Info:Paragraph({ Title = "Game Time", Desc = "" })
...
local MirageCheck = Tabs.Info:Paragraph({ Title = "Mirage Island", Desc = "Status: " })
...
local KitsuneCheck = Tabs.Info:Paragraph({ Title = "Kitsune Island", Desc = "Status: " })
...
local PrehistoricCheck = Tabs.Info:Paragraph({ Title = "Prehistoric Island", Desc = "Status: " })
...
local FrozenCheck = Tabs.Info:Paragraph({ Title = "Frozen Dimension", Desc = "Status: " })
...
local CakePrinceStatus = Tabs.Info:Paragraph({ Title = "Cake Prince", Desc = "" })
...
local RipIndraCheck = Tabs.Info:Paragraph({ Title = "Rip Indra", Desc = "Status: " })
...
local DoughKingCheck = Tabs.Info:Paragraph({ Title = "Dough King", Desc = "Status: " })
...
local FullMoonCheck = Tabs.Info:Paragraph({ Title = "Full Moon", Desc = "" })
...
local LegendarySwordCheck = Tabs.Info:Paragraph({ Title = "Legendary Sword", Desc = "Status: " })
...
local BoneCount = Tabs.Info:Paragraph({ Title = "Bone", Desc = "" })
...
Tabs.Main:Section({ Title = "Collect Berry" })
...
BerryH = Tabs.Main:Toggle({
    Flag = "Toggle_Auto_Farm_Berry_Hop",
...
Tabs.Main:Section({ Title = "Farm All Island" })
...
Tabs.Main:Section({ Title = "Farm Elite Hunter" })

local Process = Tabs.Main:Paragraph({ Title = "Elites Process", Desc = "" })
spawn(function()
    while wait(Sec) do
        pcall(function()    
...
local EliteHunter = Tabs.Main:Paragraph({ Title = "Elite Spawn", Desc = "Status: " })
spawn(function()
...
EliteH = Tabs.Main:Toggle({
    Flag = "Toggle_Auto_Farm_Elite_Hop",
...
Tabs.Main:Section({ Title = "Farm Rip Indra" })
...
Tabs.Main:Section({ Title = "Farming Cake" })
local MobKilled = Tabs.Main:Paragraph({ Title = "Cake Princes", Desc = "" })
spawn(function()
    while wait(0.2) do
        pcall(function()
...
Tabs.Main:Toggle({
    Flag = "Toggle_Auto_Farm_Dough_King_Hop",
...
Tabs.Main:Section({ Title = "Farming Bone" })

local CheckingBone = Tabs.Main:Paragraph({ Title = "Bones", Desc = "" })
spawn(function()
    while wait(0.2) do
        pcall(function()
...
Tabs.Main:Section({ Title = "Tyrant of the Skies" })

local TyrantStatus = Tabs.Main:Paragraph({ Title = "Boss Spawn", Desc = "" })
spawn(function()
    pcall(function()
        while wait(1) do
...
local EyeStatus = Tabs.Main:Paragraph({ Title = "Check Status Eyes", Desc = "" })
...
Tabs.Main:Section({ Title = "Farm Material" })
...
Tabs.Main:Section({ Title = "Farming Mastery" })
...
Tabs.Settings:Section({ Title = "Settings / Configure" })
...
Tabs.Settings:Toggle({
    Flag = "Toggle_Auto_Hop_Server_with_time",
...
Tabs.Esp:Section({ Title = "Stats Upgrade" })

StatusSelect = Tabs.Esp:Slider({
...
Tabs.Fish:Section({ Title = "Fishing" })
...
FishingToggle = Tabs.Fish:Toggle({
...
-- Quest mode (Single / Double / Triple)
Tabs.Quests:Section({ Title = "Quest Mode" })
Tabs.Quests:Toggle({
    Title = "Single Quest",
...
Tabs.Quests:Section({ Title = "Tushita + Yama" })
...
Tabs.Quests:Section({ Title = "Skull Guitars / Misc" })
local CheckSoul = Tabs.Quests:Paragraph({ Title = "Skull Guitar Quests", Desc = "" })
spawn(function()
    while wait(0.2) do
        pcall(function()
            if Quest1 == true then 
...
Tabs.Quests:Section({ Title = "Cursed Dual Katana" })
local CheckCDK = Tabs.Quests:Paragraph({ Title = "Number Cursed dual katana quests", Desc = "Quest Numbers :" })
spawn(function()  
    while wait(0.2) do 
...
Tabs.Quests:Section({ Title = "True Triple Katana Sword" })
Tabs.Quests:Button({
...
Tabs.Quests:Section({ Title = "Pole / God Enal's" })
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section({ Title = "Rengoku Sword" })
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section({ Title = "Cavender + Twin Hooks + Bigmom" })
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section({ Title = "Buso/Aura Colours" })
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section({ Title = "Instinct / Observation" })
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section({ Title = "Fighting Melee Styles" })
...
Tabs.Race:Section({ Title = "Mystic Island / Full Moon" })
local FullMOOn = Tabs.Race:Paragraph({ Title = "FullMoon Status", Desc = "" })
local Ismirage = Tabs.Race:Paragraph({ Title = "Mirage Island Status", Desc = "" })
spawn(function()
    while wait(0.2) do
...
Tabs.Race:Section({ Title = "Upgrade Races V2 And V3" })
...
Tabs.Race:Section({ Title = "Trials Quest V4" })
local CheckTier = Tabs.Race:Paragraph({ Title = "Tiers V4 Status", Desc = "" })
spawn(function()
    pcall(function()
        while wait(0.2) do
...
Tabs.Prehistoric:Section({ Title = "Dojo Quest" })
...
BlazeEM = Tabs.Prehistoric:Toggle({
...
Tabs.Prehistoric:Section({ Title = "Drago Trial" })
...
fireflower = Tabs.Prehistoric:Toggle({
...
dragoTpVolcano = Tabs.Prehistoric:Toggle({
...
bdrago = Tabs.Prehistoric:Toggle({
...
UpTalon = Tabs.Prehistoric:Toggle({
...
Tabs.Prehistoric:Section({ Title = "Volcanic Crafting" })
...
local Check_Volcano = Tabs.Prehistoric:Paragraph({ Title = "Prehistoric Island Status", Desc = "" })
spawn(function()
    while wait(0.2) do
        if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
...
Tabs.SeaEvent:Section({ Title = "Sea Event / Setting Sail" })
...
Tabs.SeaEvent:Section({ Title = "Crafting Items" })
...
Tabs.SeaEvent:Section({ Title = "Choose Sea Event" })
...
Tabs.SeaEvent:Section({ Title = "Entity Sea Event" })
...
Tabs.SeaEvent:Section({ Title = "Kitsune Island / Event" })
local Check_Kitsu = Tabs.SeaEvent:Paragraph({ Title = "Kitsune Island Status", Desc = "" })
spawn(function()
    while wait(0.2) do
...
Tabs.SeaEvent:Section({ Title = "Frozen Dimension Event" })

local FloD = Tabs.SeaEvent:Paragraph({ Title = "FrozenDimension Status", Desc = "" })
spawn(function()
    pcall(function()
        while wait(0.2) do
...
local SPYING = Tabs.SeaEvent:Paragraph({ Title = "Spy Status", Desc = "" })
spawn(function()
    while wait(0.2) do
        pcall(function()
...
Tabs.Raids:Section({ Title = "Fruits Options" })
...
local stockParagraph = Tabs.Raids:Paragraph({ Title = "Stock Fruit", Desc = "Loading..." })
...
Tabs.Raids:Section({ Title = "Dungeon Event / Raiding" })
...
AutoChipBeli = Tabs.Raids:Toggle({
...
AutoChipFruit = Tabs.Raids:Toggle({
...
Tabs.Raids:Section({ Title = "Items Law/Order Sword" })
...
Tabs.Raids:Section({ Title = "Raids Dungeons" })
...
Tabs.Combat:Section({ Title = "Combat / AimBot" })

local __indexPlayer = Tabs.Combat:Paragraph({ Title = "All Players On Server", Desc = "" })
...
local __AimBotTurn = Tabs.Combat:Paragraph({ Title = "Aimbot Status", Desc = "" })
...
Tabs.Combat:Section({ Title = "Quests Players" })
...
Tabs.Combat:Section({ Title = "LocalPlayer Settings" })
...
Tabs.Travel:Section({ Title = "Travel - Worlds" })
...
Tabs.Travel:Section({ Title = "Travel - Island" })
Location = {}
for i,v in pairs(workspace["_WorldOrigin"].Locations:GetChildren()) do  
...
Tabs.Travel:Section({ Title = "Travel - Portal" })
if World1 then
  Location_Portal = {
    "Sky",
    "UnderWater"
...
Tabs.Misc:Input({ Flag = "Input_Input_Job_Id",
    Title = "Input Job Id",
    Placeholder = "Job ID",
    Callback = function(Value)
        getgenv().Job = Value
