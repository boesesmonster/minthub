...
Tabs.Volcano:Section({ Title = "Drago Trial" })
...
Toggle = Tabs.Volcano:Toggle({
    Flag = "Toggle_Tween_To_Upgrade_Droco_Trial",
...
Toggle = Tabs.Volcano:Toggle({
    Flag = "Toggle_Auto_Relic_Drago_Trial_Beta",
...
Toggle = Tabs.Volcano:Toggle({
    Flag = "Toggle_Auto_Train_Drago_v4",
...
dragoTpVolcano = Tabs.Volcano:Toggle({
    Flag = "Toggle_Tween_to_Drago_Trials",
