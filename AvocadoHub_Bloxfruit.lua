...
-- Same tab layout as original (WindUI tabs), WindUI API
local Tabs = {
    Info = Window:Tab({ Title = "Tab Info And Status", Icon = "info" }),
    Main = Window:Tab({ Title = "Tab Farming", Icon = "sword" }),
    Settings = Window:Tab({ Title = "Tab Setting", Icon = "settings" }),
    Fish = Window:Tab({ Title = "Tab Fishing", Icon = "fish" }),
    Quests = Window:Tab({ Title = "Tab Quest And Item", Icon = "file-text" }),
    SeaEvent = Window:Tab({ Title = "Tab Sea Event", Icon = "waves" }),
    Race = Window:Tab({ Title = "Tab Mirage And Race", Icon = "moon" }),
    Prehistoric = Window:Tab({ Title = "Tab Volcano Event", Icon = "flame" }),
    Esp = Window:Tab({ Title = "Tab Stats And Esp", Icon = "eye" }),
    Raids = Window:Tab({ Title = "Tab Fruit And Raid", Icon = "zap" }),
    Combat = Window:Tab({ Title = "Tab Local Player", Icon = "user" }),
    Travel = Window:Tab({ Title = "Tab Teleport", Icon = "map-pin" }),
    Shop = Window:Tab({ Title = "Tab Shopping", Icon = "shopping-cart" }),
    Misc = Window:Tab({ Title = "Tab Miscellaneous", Icon = "more-horizontal" })
}
